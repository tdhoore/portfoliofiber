...
export default function HomeScene(props) {
  ...
  return (
    <group ref={group} {...props}>
      ...
      <object3D
        name="Point030"
        position={[0.7004144787788391, 3.1274778842926025, -10.807682991027832]}
      >
        <pointLight
      ...
      <object3D
        name="Point031"
        position={[-0.9242984652519226, 2.735767364501953, -10.993736267089844]}
      >
        <pointLight
      ...
      <object3D
        name="Point032"
        position={[0.7464666962623596, 1.0204486846923828, -10.993736267089844]}
      >
        <pointLight
      ...
      <object3D
        name="Point035"
        position={[-1.7738419771194458, 0.7362266182899475, -4.215659141540527]}
      >
        <pointLight
      ...
      <object3D
        name="Point035 copy"
        position={[2.0738419771194458, 2.7362266182899475, -4.215659141540527]}
      >
        <pointLight
      ...
      <mesh
        name="home_top_left"
        position={[-1.8780152797698975, 6.634069919586182, -4.117544651031494]}
        castShadow
        receiveShadow
      >
        <group
      ...
      <mesh
        ...
        position={[-4.695050239562988, -1.0850317478179932, -5.85163688659668]}
        castShadow
        receiveShadow
      >
